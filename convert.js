...
(() => {
  ...
  var WEBRTC_STUN_UDP_PORTS, WEBRTC_STUN_PROXY_RULES, CORE_DIRECT_RULES, DOMESTIC_PLATFORM_RULES, AI_RULES, OVERSEAS_MEDIA_RULES, TW_MEDIA_RULES, DOMESTIC_SERVICE_RULES, SOCIAL_RULES, DEVELOPER_RULES, PRODUCTIVITY_RULES, DOWNLOAD_RULES, GAME_RULES, FALLBACK_RULES, baseRules;
  ...
  var LOCAL_DOMAIN_FAKE_IP_FILTER, BASE_FAKE_IP_FILTER, LAN_COMPAT_FAKE_IP_FILTER, snifferConfig;
  var init_dns = __esm({
    "src/dns.ts"() {
      "use strict";
