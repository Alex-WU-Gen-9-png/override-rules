...
(() => {
  ...
  // src/constants.ts
  var NODE_SUFFIX, CDN_URL, SELF_CDN_URL, PROXY_GROUPS, LOW_COST_NODE_MATCHER, LANDING_NODE_MATCHER, countriesMeta;
  ...
  var WEBRTC_STUN_UDP_PORTS, WEBRTC_STUN_PROXY_RULES, baseRules;
  var init_rules = __esm({
    "src/rules.ts"() {
      ...
      baseRules = [
        ...
        `DOMAIN-SUFFIX,aliyuncs.com,${PROXY_GROUPS.DIRECT}`,
        `DOMAIN-SUFFIX,aliyun-inc.com,${PROXY_GROUPS.DIRECT}`,
        `DOMAIN-SUFFIX,dingtalk.com,${PROXY_GROUPS.DIRECT}`,
        `DOMAIN-SUFFIX,aliwork.com,${PROXY_GROUPS.DIRECT}`,
  ...
  // src/tun.ts
  function buildTunConfig({ tunEnabled, lanEnabled }) {
    return {
      enable: tunEnabled,
      stack: "system",
      device: "Mihomo_Tun",
      "route-exclude-address": lanEnabled ? LAN_ROUTE_EXCLUDE_ADDRESS : DEFAULT_ROUTE_EXCLUDE_ADDRESS,
