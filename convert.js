...
(() => {
  ...
  var LOCAL_DOMAIN_FAKE_IP_FILTER, NTP_FAKE_IP_FILTER, BASE_FAKE_IP_FILTER, LAN_COMPAT_FAKE_IP_FILTER, snifferConfig;
  var init_dns = __esm({
    "src/dns.ts"() {
      "use strict";
      ...
      LAN_COMPAT_FAKE_IP_FILTER = ["geosite:cn", "+.zju.edu.cn", ...BASE_FAKE_IP_FILTER];
      snifferConfig = {
        sniff: {
          TLS: {
            ports: [443, 8443]
