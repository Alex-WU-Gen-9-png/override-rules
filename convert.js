...
(() => {
  ...
  var SYSTEM_DNS_SERVER, WECHAT_QQ_DNS_POLICY_RULE_SETS, LOCAL_DOMAIN_FAKE_IP_FILTER, NTP_FAKE_IP_FILTER, BASE_FAKE_IP_FILTER, snifferConfig;
  var init_dns = __esm({
    "src/dns.ts"() {
      "use strict";
      SYSTEM_DNS_SERVER = "system";
